    ...
    <div className="app-shell">
      <aside className={`sidebar ${mobileOpen ? 'open' : ''}`}>
        <div className="brand">
          ...
          <div>
            ...
            <span>Dữ liệu gọn, thao tác nhanh</span>
          </div>
        </div>
        <nav>
      ...
      <main className="main-area">
        <header className="topbar">
          ...
          <form className="global-search" onSubmit={submitSearch}><Search size={17} /><input value={query} onChange={(event) => setQuery(event.target.value)} placeholder="Tìm khách, đàn, serial, số điện thoại..." /></form>
