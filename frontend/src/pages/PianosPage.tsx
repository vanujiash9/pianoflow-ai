...
export function PianosPage() {
  ...
  return <>
    <PageHeader title="Đàn tại shop" subtitle="Theo dõi từng cây theo model, serial và trạng thái thực tế." actions={<button className="primary-button" onClick={()=>setOpen(true)}><Plus size={17}/> Thêm đàn</button>}/>
